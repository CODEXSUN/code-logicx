import { loadEnv } from "@codelogicx/framework/env";
import { z } from "zod";
...
const envSchema = z.object({
  ...
  PLATFORM_WEB_PORT: z.coerce.number().int().positive().default(9160),
  ...
  CODELOGICX_DB_FRESH_ON_START: z.enum(["0", "1"]).default("0"),
  CODELOGICX_DB_RESET_CONFIRM: z.string().default(""),
  CODELOGICX_ALLOW_PRODUCTION_DB_RESET: z.enum(["0", "1"]).default("0"),
  ...
  CODELOGICX_CODEX_HOME: z.string().optional(),
