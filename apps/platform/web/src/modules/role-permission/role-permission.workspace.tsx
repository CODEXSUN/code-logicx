...
import { Checkbox } from "@codelogicx/ui/components/checkbox";
...
function roleDescription(roleKey: string) {
  if (roleKey === "super-admin") return "All platform and CodeLogicX controls.";
  if (roleKey === "admin") return "Administration and engineering access.";
  return "Choose the CodeLogicX features this role can use.";
}
