...
const TOKEN_KEY = "codelogicx_session";
const SESSION_EXPIRED_WARNING_KEY = "codelogicx_session_expired_warning";
...
async function request<T>(path: string, options: RequestInit = {}): Promise<T> {
  ...
  if (!envelope) throw new Error("CodeLogicX API returned an empty response.");
