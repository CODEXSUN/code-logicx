...
describe("Compass Runner standalone E2E", () => {
  ...
  it("keeps every CodeLogicX release mutation behind an interactive approval", async () => {
    let phase = 0;
    const runner = new CompassRunner(makeTask("release", "Prepare the next CodeLogicX IDE release.", "opencode"), scripted("opencode", (_context) => {
