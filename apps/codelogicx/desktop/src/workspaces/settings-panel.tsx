...
function DedicatedProviderTab({
  ...
  const [siteReferer, setSiteReferer] = useState("https://codelogicx.codexsun.com");
  const [siteTitle, setSiteTitle] = useState("CodeLogicX");
            ...
            <div className="connect-card-title">
              ...
              <div>
                ...
                <span className="connect-subtitle">
                  Pair CodeLogicX using Device Code or Browser OAuth validation
                </span>
              </div>
            </div>
          ...
          <div className="settings-grid">
            ...
            <div className="setting-item">
              ...
              <input
                ...
                placeholder="https://codelogicx.codexsun.com"
                className="setting-input"
              />
              <div className="setting-hint">
