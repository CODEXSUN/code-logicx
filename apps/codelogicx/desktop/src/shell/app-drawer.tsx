...
import codeLogicXLogo from "../../src-tauri/icons/icon.png";
  ...
  return (
    <div className="app-drawer-layer">
      <button
        ...
        type="button"
      />
      <aside aria-label="CodeLogicX menu" aria-modal="true" className="app-drawer" role="dialog">
        <header>
          <span>
            <img alt="" className="product-icon" src={codeLogicXLogo} /> CodeLogicX
          </span>
