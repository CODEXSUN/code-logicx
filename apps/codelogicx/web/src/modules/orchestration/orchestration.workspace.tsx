import { Button, Card, CardContent, WorkspacePage, WorkspaceStatusBadge } from "@codelogicx/ui";
import {
  ActivityIcon,
  ArrowRightIcon,
  BotIcon,
...
export function OrchestrationWorkspace() {
  ...
  return (
    <WorkspacePage
      actions={
        <div className="flex flex-wrap gap-2">
          <Button asChild variant="outline">
            <a href="/app/codelogicx/projects">
              Open projects
              <ArrowRightIcon />
            </a>
          </Button>
      ...
      technicalName="codelogicx.orchestration"
    ...
    >
          ...
          <div>
            <div className="mb-3 flex flex-wrap items-center gap-2">
              ...
              <WorkspaceStatusBadge
                label={`Technical core: ${catalog?.technicalName ?? "codelogicx"}`}
                tone="neutral"
              />
            </div>
      ...
      <Section
        description="A visible path from idea to operation. Connected stages use existing CodeLogicX modules; foundation and planned stages remain explicit."
        icon={<WorkflowIcon />}
      ...
      >
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          <Signal
            ...
            href="/app/codelogicx/github"
          />
          <Signal
            label="Failed checks"
            value={today?.failedChecks.length ?? 0}
            href="/app/codelogicx/today"
          />
          <Signal
