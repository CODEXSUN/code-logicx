    ...
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-9 p-8 lg:p-12">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-base leading-7 text-muted-foreground">
          Authorize CodeLogicX as a Telegram application. Scan the QR code with a Telegram mobile
    ...
    <>
      ...
      <div className="flex max-w-md flex-col gap-2">
        ...
        <p className="text-sm leading-6 text-muted-foreground">
          CodeLogicX will create a short-lived QR code. Approve it from Telegram under Settings →
...
function ConnectedState({
  ...
  return (
    <>
      ...
      <Button asChild>
        <a href="/app/codelogicx/telegram-chat">Open Telegram workspace</a>
      </Button>
