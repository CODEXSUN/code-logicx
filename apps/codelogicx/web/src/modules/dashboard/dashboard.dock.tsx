...
const items: DockItem[] = [
  ...
  { href: "/app/codelogicx/ideas", icon: LightbulbIcon, label: "Ideas" },
  { href: "/app/codelogicx/tasks", icon: ListTodoIcon, label: "Todos" },
  { href: "/app/codelogicx/agent-ide", icon: BotIcon, label: "Project Agent" },
  { href: "/app/codelogicx/apps", icon: LayoutGridIcon, label: "App Desk" }
];
