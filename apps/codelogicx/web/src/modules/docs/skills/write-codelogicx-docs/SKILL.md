---
name: write-codelogicx-docs
description: Write, edit, review, or add CodeLogicX documentation pages, MDX content, documentation SVGs, sidebar entries, and page navigation under apps/codelogicx/web/src/modules/docs. Use for every change to the CodeLogicX Documentation workspace.
---

# Write CodeLogicX Docs
...
Run the Docs formatting check, CodeLogicX web typecheck, CodeLogicX web lint, and platform web production build. Report only checks that ran.
