import { apiGet, apiPost, apiPut } from "../../shared/api/codelogicx-api";
import type {
  HoneyConversation,
...
export function readHoneyPageContext(): HoneyPageContext {
  ...
  const previousPage = window.sessionStorage.getItem("codelogicx.honey.last-page");
  return {
    ...
    recentError: window.sessionStorage.getItem("codelogicx.honey.recent-error"),
