...
const destinations = [
  { icon: ClipboardCheckIcon, title: "My Work", url: "/app/codelogicx/my-work" },
  { icon: FolderKanbanIcon, title: "Projects", url: "/app/codelogicx/projects" },
  { icon: ListChecksIcon, title: "Tasks", url: "/app/codelogicx/tasks" },
  { icon: CircleDotIcon, title: "Issues", url: "/app/codelogicx/issues" },
  { icon: MapIcon, title: "Roadmap", url: "/app/codelogicx/roadmap" },
  { icon: CalendarRangeIcon, title: "Sprints", url: "/app/codelogicx/sprints" },
  { icon: GitPullRequestArrowIcon, title: "Releases", url: "/app/codelogicx/releases" }
] as const;
...
export function WorkOverviewWorkspace() {
  ...
  const summaries = [
    summary("My Work", activeTodos.length, dueContext(activeTodos), "/app/codelogicx/my-work"),
    ...
    summary(
      ...
      releaseContext(activeReleases),
      "/app/codelogicx/releases"
    )
  ];
