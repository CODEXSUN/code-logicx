import { Button, Card, CardContent, WorkspacePage } from "@codelogicx/ui";
import {
  AlertTriangle,
  CheckCircle2,
  FolderGit2,
...
export function GithubDashboardWorkspace() {
  ...
  if (selectedProject) {
    return (
      <WorkspacePage
        ...
        technicalName={`codelogicx.github-dashboard.${selectedProject}`}
  ...
  return (
    <WorkspacePage
      ...
      technicalName="codelogicx.github-dashboard"
