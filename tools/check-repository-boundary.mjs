...
const internalPackages = new Map([
  ["@codelogicx/framework", "packages/framework"],
  ["@codelogicx/ui", "packages/ui"],
  ["@codelogicx/codelogicx-api", "apps/codelogicx/api"],
  ["@codelogicx/codelogicx-web", "apps/codelogicx/web"]
]);
const failures = [];
...
const boundaryFiles = [
  ...
  "apps/codelogicx/api/package.json",
  "apps/codelogicx/web/package.json",
...
console.info(
  "Repository boundary verified: CodeLogicX, Framework, and UI resolve from internal workspaces only."
);
