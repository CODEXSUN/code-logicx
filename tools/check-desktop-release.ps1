...
$installerName = "CodeLogicX_${version}_x64_en-US.msi"
$setupName = "CodeLogicX_Setup_${version}_x64.exe"
...
Assert-Equal $setup.VersionInfo.FileDescription "CodeLogicX Setup" "setup description"
Assert-Equal $setup.VersionInfo.FileVersion $version "setup file version"
Assert-Equal $setup.VersionInfo.ProductName "CodeLogicX" "setup product"
Assert-Equal $setup.VersionInfo.ProductVersion $version "setup product version"

Assert-Equal (Read-MsiProperty $installerPath "ProductName") "CodeLogicX" "MSI product"
...
$expectedUrl = "https://github.com/CODEXSUN/codelogicx/releases/download/desktop-v$version/$installerName"
...
Write-Output "Desktop release check passed for CodeLogicX $version."
