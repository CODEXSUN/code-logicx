...
- Use CodeLogicX for user-facing product branding and `codelogicx` for technical contracts.
- Each CodeLogicX module owns its routes, services, repositories, migration, seed, types, and web
  workspace.
- Do not move CodeLogicX business behavior into Platform or shared helpers.
