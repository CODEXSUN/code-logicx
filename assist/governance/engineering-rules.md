...
- Keep fixed `/api/codelogicx/*` route contracts and explicit Zod request schemas.
- Protect system records and CodeLogicX permissions in backend services or host authorization.
