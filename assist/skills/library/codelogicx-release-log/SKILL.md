---
name: codelogicx-release-log
description: Prepare a CodeLogicX changelog and version-evidence job without committing, publishing, or deploying. Use when a project needs release notes or version verification.
---

# CodeLogicX Release Log
