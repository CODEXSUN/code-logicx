---
name: codelogicx-github-desktop-release
description: Prepare, publish, and verify a versioned CodeLogicX Desktop GitHub release. Use for an authorized commit/pull/push, signed desktop release, release-workflow failure, or updater-asset verification; do not use for VPS deployment.
---

# CodeLogicX GitHub Desktop Release

Use this skill only when the user has explicitly authorized GitHub mutations.
It releases the CodeLogicX Tauri desktop application from this repository. It does
...
3. Keep every workspace package and every versioned internal dependency under
   `@codelogicx/` or `@codelogicx/` aligned to the root version. The matching entries
