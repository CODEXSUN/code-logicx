---
name: codelogicx-agent-tools
description: Apply CodeLogicX's shared desktop agent tool policy for inspection, planning, edits, refactors, checks, and reviews.
---

# CodeLogicX Agent Tools
