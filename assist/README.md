...
CodeLogicX is standalone and single-client. Platform supplies local identity, authorization, one
MariaDB connection, and the executable API/web shell. CodeLogicX supplies developer planning,
