...
| Web UI | Use React, Tailwind CSS, Radix UI, and shared UI components. | Current | CodeLogicX web |
...
| Jobs | Use MariaDB as the source of truth. Use BullMQ and Redis as delivery adapters. | Current | CodeLogicX API |
