...
The internal runtime used to compose CodeLogicX into one API and one web platform.

## Package exports

`@codelogicx/framework` provides stable framework and application contracts, with public subpath exports for API composition, configuration, database, environment, errors, events, health, HTTP, logging, modules, queues, and storage.
