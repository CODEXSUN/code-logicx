...
export function ScreenMascot({ chat, label, spriteSheetUrl, visible }: ScreenMascotProps) {
  ...
  const documentationMode = window.location.pathname.startsWith("/app/codelogicx/docs");
  ...
  useEffect(() => {
    ...
    window.addEventListener("codelogicx:honey-documentation-anchor-ready", restore);
    window.addEventListener("resize", restore);
    return () => {
      window.cancelAnimationFrame(frame);
      window.removeEventListener("codelogicx:honey-documentation-anchor-ready", restore);
